...
{/// <summary>
    ...
    public partial class IPBox : UserControl
    {
        ...
        {
            if (
                !string.IsNullOrEmpty(ipTextBox1.Text) ||
                !string.IsNullOrEmpty(ipTextBox2.Text) ||
                !string.IsNullOrEmpty(ipTextBox3.Text) ||
                !string.IsNullOrEmpty(ipTextBox4.Text)
                )
            {
